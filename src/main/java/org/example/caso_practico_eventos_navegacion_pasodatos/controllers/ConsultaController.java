...
public class ConsultaController {
    ...
    private void mostrarDetalleCliente(Cliente cliente) {
        ...
        String serviciosStr = cliente.getServiciosInteres() != null ? String.join(", ", cliente.getServiciosInteres()) : "Ninguno";
        vbox.getChildren().add(new Label("Servicios de Interés: " + serviciosStr));
